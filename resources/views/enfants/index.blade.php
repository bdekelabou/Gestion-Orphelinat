                        ...
                        <tbody>
                            @foreach ($enfants as $enfant)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('enfants.show', $enfant->id) }}" class="btn btn-warning"><i class="fas fa-eye fa-sm"></i></a>
                                    </td>
                                    <td>
                                        <a href="{{ route('enfants.scolaire', $enfant->id) }}" class="btn btn-warning"><i class="fas fa-eye fa-sm"></i></a>
                                    </td>
