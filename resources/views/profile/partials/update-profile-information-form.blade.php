<section
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="nom_utilisateur" name="nom_utilisateur" type="text" class="mt-1 block w-full" :value="old('nom_utilisateur', $user->nom_utilisateur)" required autofocus autocomplete="name" />
